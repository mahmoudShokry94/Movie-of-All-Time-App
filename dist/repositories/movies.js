...
exports.deleteMovie = exports.updateMovie = exports.getMovieById = exports.insertMovie = exports.getMovies = void 0;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    mappedFilters = { isDeleted: false };
                    if (filters.movieGenre) {
                        mappedFilters.genre = { $in: [filters.movieGenre] };
                    }
                    if (filters.movieName) {
                        mappedFilters.title = {
                            $regex: new RegExp((0, mongo_utils_1.mongoInputSanitize)(filters.movieName), "i"),
                        };
                    }
                    return [4 /*yield*/, movies_1.default.aggregate([
                            { $match: mappedFilters },
                            {
                                $facet: {
                                    results: [
...
var insertMovie = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, movies_1.default.create(payload)];
    });
}); };
...
var getMovieById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, movies_1.default.findOne({ movieId: id, isDeleted: false }).select("-_id -__v -createdAt -updatedAt")];
    });
}); };
exports.getMovieById = getMovieById;
var updateMovie = function (movieId, payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("Respository...updateMovie...");
                return [4 /*yield*/, movies_1.default.findOneAndUpdate({ movieId: movieId }, { $set: payload }, { new: true }).select("-_id -__v -createdAt -updatedAt")];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
exports.updateMovie = updateMovie;
var deleteMovie = function (movieId) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("Respository...deleteMovie...");
                return [4 /*yield*/, movies_1.default.findOneAndUpdate({ movieId: movieId }, { $set: { isDeleted: true } }, { new: true }).select("-_id -__v -createdAt -updatedAt")];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
